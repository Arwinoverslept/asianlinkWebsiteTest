...
public class aboutPage extends baseTest {
	...
	public void aboutsPageTest() throws InterruptedException {
		...
		List<String> xpaths = Arrays.asList("//img[@alt='Kevin D Keng']", "//img[@alt='Jose Czarauz Parra']",
				"//img[@alt='Cesar De Guzman']", "//img[@alt='Maria Melanie De Leon']", "//img[@alt='Dexter Ganibe']",
				"//img[@alt='Erick Dela Rosa']", "//img[@alt='Raquel Mallannao']", "//img[@alt='Jason Isaac Benitez']");
